    ...
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getSubLineChartDataByYear`,
          {
            data: {
              ...props.requestData,
            },
...
function TmsMonthlyLineChart(props) {
  ...
  React.useEffect(() => {
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getSubLineChartDataByMonth`,
          {
            data: {
              ...props.requestData,
            },
...
function TmsQuarterlyLineChart(props) {
  ...
  React.useEffect(() => {
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getSubLineChartDataByQuarter`,
          {
            data: {
              ...props.requestData,
            },
...
function TmsSemiAnualLineChart(props) {
  ...
  React.useEffect(() => {
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getSubLineChartDataSemiAnually`,
          {
            data: {
              ...props.requestData,
            },
