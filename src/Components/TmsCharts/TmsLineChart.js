    ...
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getLineChartDataByYear`,
          {
            data: {
              ...props.requestData,
            },
...
function TmsMonthlyLineChart(props) {
  ...
  React.useEffect(() => {
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getLineChartDataByMonth`,
          {
            data: {
              ...props.requestData,
            },
...
function TmsQuarterlyLineChart(props) {
  ...
  React.useEffect(() => {
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getLineChartDataByQuarter`,
          {
            data: {
              ...props.requestData,
            },
...
function TmsSemiAnuallyLineChart(props){
  ...
  React.useEffect(() => {
    async function fetchLineChartData() {
      try {
        const response = await axios.post(
          `http://127.0.0.1:8000/getLineChartDataSemiAnually`,
          {
            data: {
              ...props.requestData,
            },
